...
public class chia_10cau_cotime extends AppCompatActivity {
    ...
    public void onBackPressed() {
        phatAmThanh();
        Intent intent1 = new Intent(chia_10cau_cotime.this, MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chia_10cau_cotime);
        ...
        imgCross.setOnClickListener(v -> {
            Intent intent = new Intent(chia_10cau_cotime.this, MainActivity.class);
            phatAmThanh();
        ...
        btnPlay.setOnClickListener(v -> {
            if (!selectedLevel.isEmpty()) {
                ...
                if (selectedLevel.equals("level1")) {
                    intent = new Intent(chia_10cau_cotime.this, chia_10cau_cotime_sc.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                } else if (selectedLevel.equals("level2")) {
                    intent = new Intent(chia_10cau_cotime.this, chia_10cau_cotime_tc.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                } else if (selectedLevel.equals("level3")) {
                    intent = new Intent(chia_10cau_cotime.this, chia_10cau_cotime_cc.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                } else {
