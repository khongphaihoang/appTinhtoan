...
import com.example.apptinhtoan.pheptoan.TaoPhepChia3So;

public class chia_10cau_cotime_cc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Khởi tạo phép toán từ TaoPhepChia3So
        TaoPhepChia3So TaoPhepChia3So = new TaoPhepChia3So();
        PhepChia PhepChia = TaoPhepChia3So.taoBaiToan();
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(chia_10cau_cotime_cc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(chia_10cau_cotime_cc.this, chia_10cau_cotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(chia_10cau_cotime_cc.this, manhinh_end.class);
