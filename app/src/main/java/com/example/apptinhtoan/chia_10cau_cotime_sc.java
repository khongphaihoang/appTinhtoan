...
import com.example.apptinhtoan.pheptoan.PhepChia;
import com.example.apptinhtoan.pheptoan.TaoPhepChia1So;

public class chia_10cau_cotime_sc extends AppCompatActivity {
    ...
    private Runnable chayDongHo = new Runnable() {
        @Override
        public void run() {
            long thoiGianTrungGian  = System.currentTimeMillis() - thoiGianBatDau;
            int giay = (int) (thoiGianTrungGian / 1000);
            dongHoTextView.setText(String.valueOf(giay));
            xuLy.postDelayed(this, 1000);
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cong_10cau_cotime_sc);
        ...
        // Khởi tạo phép toán từ TaoPhepChia1So
        TaoPhepChia1So TaoPhepChia1So = new TaoPhepChia1So();
        PhepChia PhepChia = TaoPhepChia1So.taoBaiToan();
        soHang1 = PhepChia.getSo1();
        soHang2 = PhepChia.getSo2();
        dapAnDung = soHang1 / soHang2;  // Cập nhật đáp án đúng

        // Hiển thị phép toán ban đầu
        phepToanTextView.setText(PhepChia.getBaiToan());

        thoiGianBatDau = System.currentTimeMillis(); // Bắt đầu tính thời gian
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(chia_10cau_cotime_sc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(chia_10cau_cotime_sc.this, chia_10cau_cotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        thoiGianDaChay = thoiGianKetThuc - thoiGianBatDau;



        // Chuyển sang màn hình kết quả
        Intent intent = new Intent(chia_10cau_cotime_sc.this, manhinh_end.class);
        intent.putExtra("totalTime", thoiGianDaChay / 1000);  // Thời gian tính bằng giây
