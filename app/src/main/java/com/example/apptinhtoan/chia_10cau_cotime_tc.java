...
import com.example.apptinhtoan.pheptoan.TaoPhepChia2So;

public class chia_10cau_cotime_tc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cong_10cau_cotime_cc);
        ...
        // Khởi tạo phép toán từ TaoPhepChia2So
        TaoPhepChia2So TaoPhepChia2So = new TaoPhepChia2So();
        PhepChia PhepChia = TaoPhepChia2So.taoBaiToan();
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(chia_10cau_cotime_tc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(chia_10cau_cotime_tc.this, chia_10cau_cotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(chia_10cau_cotime_tc.this, manhinh_end.class);
