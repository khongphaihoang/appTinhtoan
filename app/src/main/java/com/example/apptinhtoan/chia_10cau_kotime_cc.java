...
public class chia_10cau_kotime_cc extends AppCompatActivity {
    ...
    private void hienHopThoaiXacNhanThoat() {
        AlertDialog.Builder builder = new AlertDialog.Builder(chia_10cau_kotime_cc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(chia_10cau_kotime_cc.this, chia_10cau_kotime.class);
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(chia_10cau_kotime_cc.this, manhinh_end.class);
