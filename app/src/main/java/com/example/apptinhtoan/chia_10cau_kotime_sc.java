...
public class chia_10cau_kotime_sc extends AppCompatActivity {
    ...
    private void hienHopThoaiXacNhanThoat() {
        AlertDialog.Builder builder = new AlertDialog.Builder(chia_10cau_kotime_sc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(chia_10cau_kotime_sc.this, chia_10cau_kotime.class);
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(chia_10cau_kotime_sc.this, manhinh_end.class);
