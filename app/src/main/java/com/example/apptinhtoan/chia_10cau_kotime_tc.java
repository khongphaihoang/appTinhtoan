...
public class chia_10cau_kotime_tc extends AppCompatActivity {
    ...
    private void hienHopThoaiXacNhanThoat() {
        AlertDialog.Builder builder = new AlertDialog.Builder(chia_10cau_kotime_tc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(chia_10cau_kotime_tc.this, chia_10cau_kotime.class);
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(chia_10cau_kotime_tc.this, manhinh_end.class);
