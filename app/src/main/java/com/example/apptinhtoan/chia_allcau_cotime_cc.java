...
public class chia_allcau_cotime_cc extends AppCompatActivity {
    ...
    private static final int THOI_GIAN_LIMIT = 120; // Thời gian giới hạn là 30 giây
    ...
    private Runnable chayDongHo = new Runnable() {
        ...
        public void run() {
            ...
            if (thoiGianConLai > 0) {
                ...
                Toast toast = Toast.makeText(chia_allcau_cotime_cc.this, "Hết giờ!", Toast.LENGTH_SHORT);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cong_allcau_cotime_cc);
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(chia_allcau_cotime_cc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(chia_allcau_cotime_cc.this, chia_allcau_cotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(chia_allcau_cotime_cc.this, manhinh_end2.class);
