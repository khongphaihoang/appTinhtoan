...
import com.example.apptinhtoan.pheptoan.TaoPhepCong1So;

public class cong10cau_cotime_sc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Khởi tạo phép toán từ TaoPhepCong1So
        TaoPhepCong1So taoPhepCong1So = new TaoPhepCong1So();
        PhepCong phepCong = taoPhepCong1So.taoBaiToan();
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(cong10cau_cotime_sc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(cong10cau_cotime_sc.this, LevelActivity.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(cong10cau_cotime_sc.this, manhinh_end.class);
