...
import com.example.apptinhtoan.pheptoan.TaoPhepCong2So;

public class cong10cau_cotime_tc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cong10cau_cotime_tc);
        ...
        // Khởi tạo phép toán từ cTaoPhepCong2So
        TaoPhepCong2So cTaoPhepCong2So = new TaoPhepCong2So();
        PhepCong phepCong = cTaoPhepCong2So.taoBaiToan();
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(cong10cau_cotime_tc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(cong10cau_cotime_tc.this, LevelActivity.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(cong10cau_cotime_tc.this, manhinh_end.class);
