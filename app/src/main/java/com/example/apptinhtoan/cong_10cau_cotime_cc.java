...
import com.example.apptinhtoan.pheptoan.PhepCong;
import com.example.apptinhtoan.pheptoan.TaoPhepCong3So;

public class cong_10cau_cotime_cc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Khởi tạo phép toán từ cTaoPhepCong3So
        TaoPhepCong3So cTaoPhepCong3So = new TaoPhepCong3So();
        PhepCong phepCong = cTaoPhepCong3So.taoBaiToan();
        soHang1 = phepCong.getSo1();
        soHang2 = phepCong.getSo2();
        dapAnDung = soHang1 + soHang2;  // Cập nhật đáp án đúng

        // Hiển thị phép toán ban đầu
        phepToanTextView.setText(phepCong.getBaiToan());
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(cong_10cau_cotime_cc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(cong_10cau_cotime_cc.this, LevelActivity.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(cong_10cau_cotime_cc.this, manhinh_end.class);
