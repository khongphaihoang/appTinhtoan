...
public class cong_10cau_kotime_tc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cong_10cau_kotime_tc);
    ...
    private void hienHopThoaiXacNhanThoat() {
        AlertDialog.Builder builder = new AlertDialog.Builder(cong_10cau_kotime_tc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(cong_10cau_kotime_tc.this, cong_10cau_kotime.class);
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(cong_10cau_kotime_tc.this, manhinh_end.class);
