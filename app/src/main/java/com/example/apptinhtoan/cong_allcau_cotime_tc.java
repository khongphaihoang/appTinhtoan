...
public class cong_allcau_cotime_tc extends AppCompatActivity {
    ...
    private static final int THOI_GIAN_LIMIT = 60; // Thời gian giới hạn là 30 giây
    ...
    private Runnable chayDongHo = new Runnable() {
        ...
        public void run() {
            ...
            if (thoiGianConLai > 0) {
                ...
                Toast toast = Toast.makeText(cong_allcau_cotime_tc.this, "Hết giờ!", Toast.LENGTH_SHORT);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cong_allcau_cotime_tc);
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(cong_allcau_cotime_tc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(cong_allcau_cotime_tc.this, cong_allcau_cotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(cong_allcau_cotime_tc.this, manhinh_end2.class);
