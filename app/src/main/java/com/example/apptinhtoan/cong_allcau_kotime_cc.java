...
public class cong_allcau_kotime_cc extends AppCompatActivity {
    ...
    private Runnable chayDongHo = new Runnable() {
        ...
        public void run() {
            ...
            if (thoiGianConLai > 0) {
                ...
                Toast toast = Toast.makeText(cong_allcau_kotime_cc.this, "Hết giờ!", Toast.LENGTH_SHORT);
    ...
    public void kiemTraDapAn(boolean dung) {
        ...
        if (dung) {
            ...
            finishQuiz();
            Toast toast = Toast.makeText(cong_allcau_kotime_cc.this, "Kết thúc!", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);  // Căn giữa trên màn hình
            toast.show();
        }
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(cong_allcau_kotime_cc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(cong_allcau_kotime_cc.this, cong_allcau_kotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(cong_allcau_kotime_cc.this, manhinh_end2.class);
