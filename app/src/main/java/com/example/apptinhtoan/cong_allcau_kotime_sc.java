...
public class cong_allcau_kotime_sc extends AppCompatActivity {
    ...
    private static final int THOI_GIAN_LIMIT = 7; // Thời gian giới hạn là 30 giây
    ...
    private Runnable chayDongHo = new Runnable() {
        ...
        public void run() {
            ...
            if (thoiGianConLai > 0) {
                ...
                Toast toast = Toast.makeText(cong_allcau_kotime_sc.this, "Hết giờ!", Toast.LENGTH_SHORT);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cong_allcau_kotime_sc);
    ...
    public void kiemTraDapAn(boolean dung) {
        ...
        if (dung) {
            ...
            finishQuiz();
            Toast toast = Toast.makeText(cong_allcau_kotime_sc.this, "Kết thúc!", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);  // Căn giữa trên màn hình
            toast.show();
        }
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(cong_allcau_kotime_sc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(cong_allcau_kotime_sc.this, cong_allcau_kotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(cong_allcau_kotime_sc.this, manhinh_end2.class);
