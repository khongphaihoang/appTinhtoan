...
public class nhan_10cau_cotime_sc extends AppCompatActivity {
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(nhan_10cau_cotime_sc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(nhan_10cau_cotime_sc.this, nhan_10cau_cotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(nhan_10cau_cotime_sc.this, manhinh_end.class);
