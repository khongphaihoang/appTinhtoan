...
import com.example.apptinhtoan.pheptoan.TaoPhepNhan2So;

public class nhan_10cau_cotime_tc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Khởi tạo phép toán từ TaoPhepNhan2So
        TaoPhepNhan2So TaoPhepNhan2So = new TaoPhepNhan2So();
        PhepNhan PhepNhan = TaoPhepNhan2So.taoBaiToan();
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(nhan_10cau_cotime_tc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(nhan_10cau_cotime_tc.this, nhan_10cau_cotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(nhan_10cau_cotime_tc.this, manhinh_end.class);
