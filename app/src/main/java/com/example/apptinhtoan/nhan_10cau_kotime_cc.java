...
public class nhan_10cau_kotime_cc extends AppCompatActivity {
    ...
    private void hienHopThoaiXacNhanThoat() {
        AlertDialog.Builder builder = new AlertDialog.Builder(nhan_10cau_kotime_cc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(nhan_10cau_kotime_cc.this, nhan_10cau_kotime.class);
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(nhan_10cau_kotime_cc.this, manhinh_end.class);
