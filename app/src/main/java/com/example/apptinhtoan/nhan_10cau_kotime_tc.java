...
public class nhan_10cau_kotime_tc extends AppCompatActivity {
    ...
    private void hienHopThoaiXacNhanThoat() {
        AlertDialog.Builder builder = new AlertDialog.Builder(nhan_10cau_kotime_tc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(nhan_10cau_kotime_tc.this, nhan_10cau_kotime.class);
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(nhan_10cau_kotime_tc.this, manhinh_end.class);
