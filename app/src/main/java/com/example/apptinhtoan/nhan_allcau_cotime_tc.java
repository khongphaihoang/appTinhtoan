...
public class nhan_allcau_cotime_tc extends AppCompatActivity {
    ...
    private Runnable chayDongHo = new Runnable() {
        ...
        public void run() {
            ...
            if (thoiGianConLai > 0) {
                ...
                Toast toast = Toast.makeText(nhan_allcau_cotime_tc.this, "Hết giờ!", Toast.LENGTH_SHORT);
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(nhan_allcau_cotime_tc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(nhan_allcau_cotime_tc.this, nhan_allcau_cotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(nhan_allcau_cotime_tc.this, manhinh_end2.class);
