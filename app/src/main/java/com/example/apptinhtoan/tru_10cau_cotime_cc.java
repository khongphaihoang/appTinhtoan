...
import com.example.apptinhtoan.pheptoan.PhepTru;
import com.example.apptinhtoan.pheptoan.TaoPhepTru3So;

public class tru_10cau_cotime_cc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Khởi tạo phép toán từ TaoPhepTru3So
        TaoPhepTru3So TaoPhepTru3So = new TaoPhepTru3So();
        PhepTru PhepTru = TaoPhepTru3So.taoBaiToan();
        soHang1 = PhepTru.getSo1();
        soHang2 = PhepTru.getSo2();
        dapAnDung = soHang1 - soHang2;  // Cập nhật đáp án đúng

        // Hiển thị phép toán ban đầu
        phepToanTextView.setText(PhepTru.getBaiToan());
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(tru_10cau_cotime_cc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(tru_10cau_cotime_cc.this, tru_10cau_cotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(tru_10cau_cotime_cc.this, manhinh_end.class);
