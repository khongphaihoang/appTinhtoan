...
import com.example.apptinhtoan.pheptoan.TaoPhepTru1So;

public class tru_10cau_cotime_sc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Khởi tạo phép toán từ TaoPhepTru1So
        TaoPhepTru1So TaoPhepTru1So = new TaoPhepTru1So();
        PhepTru PhepTru = TaoPhepTru1So.taoBaiToan();
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(tru_10cau_cotime_sc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(tru_10cau_cotime_sc.this, tru_10cau_cotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(tru_10cau_cotime_sc.this, manhinh_end.class);
