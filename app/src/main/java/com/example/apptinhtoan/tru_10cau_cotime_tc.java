...
import com.example.apptinhtoan.pheptoan.TaoPhepTru2So;

public class tru_10cau_cotime_tc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Khởi tạo phép toán từ TaoPhepTru2So
        TaoPhepTru2So TaoPhepTru2So = new TaoPhepTru2So();
        PhepTru PhepTru = TaoPhepTru2So.taoBaiToan();
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(tru_10cau_cotime_tc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(tru_10cau_cotime_tc.this, tru_10cau_cotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(tru_10cau_cotime_tc.this, manhinh_end.class);
