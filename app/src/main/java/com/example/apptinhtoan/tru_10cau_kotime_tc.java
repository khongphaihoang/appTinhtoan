...
public class tru_10cau_kotime_tc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tru_10cau_kotime_sc);
    ...
    private void hienHopThoaiXacNhanThoat() {
        AlertDialog.Builder builder = new AlertDialog.Builder(tru_10cau_kotime_tc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(tru_10cau_kotime_tc.this, tru_10cau_kotime.class);
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(tru_10cau_kotime_tc.this, manhinh_end.class);
