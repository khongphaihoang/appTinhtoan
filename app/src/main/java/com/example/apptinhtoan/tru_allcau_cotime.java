...
public class tru_allcau_cotime extends AppCompatActivity {
    ...
    public void onBackPressed() {
        phatAmThanh();
        Intent intent1 = new Intent(tru_allcau_cotime.this, MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tru_allcau_cotime);
        ...
        imgCross.setOnClickListener(v -> {
            Intent intent = new Intent(tru_allcau_cotime.this, MainActivity.class);
            phatAmThanh();
        ...
        btnPlay.setOnClickListener(v -> {
            if (!selectedLevel.isEmpty()) {
                ...
                if (selectedLevel.equals("level1")) {
                    intent = new Intent(tru_allcau_cotime.this, tru_allcau_cotime_sc.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                } else if (selectedLevel.equals("level2")) {
                    intent = new Intent(tru_allcau_cotime.this, tru_allcau_cotime_tc.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                } else if (selectedLevel.equals("level3")) {
                    intent = new Intent(tru_allcau_cotime.this, tru_allcau_cotime_cc.class);
                    startActivity(intent);
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                } else {
