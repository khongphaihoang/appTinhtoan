...
public class tru_allcau_cotime_tc extends AppCompatActivity {
    ...
    private Runnable chayDongHo = new Runnable() {
        ...
        public void run() {
            ...
            if (thoiGianConLai > 0) {
                ...
                Toast toast = Toast.makeText(tru_allcau_cotime_tc.this, "Hết giờ!", Toast.LENGTH_SHORT);
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(tru_allcau_cotime_tc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(tru_allcau_cotime_tc.this, tru_allcau_cotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(tru_allcau_cotime_tc.this, manhinh_end2.class);
