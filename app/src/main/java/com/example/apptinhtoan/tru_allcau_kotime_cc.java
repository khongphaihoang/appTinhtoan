...
public class tru_allcau_kotime_cc extends AppCompatActivity {
    ...
    private Runnable chayDongHo = new Runnable() {
        ...
        public void run() {
            ...
            if (thoiGianConLai > 0) {
                ...
                Toast toast = Toast.makeText(tru_allcau_kotime_cc.this, "Hết giờ!", Toast.LENGTH_SHORT);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tru_allcau_kotime_cc);
    ...
    public void kiemTraDapAn(boolean dung) {
        ...
        if (dung) {
            ...
            finishQuiz();
            Toast toast = Toast.makeText(tru_allcau_kotime_cc.this, "Kết thúc!", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);  // Căn giữa trên màn hình
            toast.show();
        }
    ...
    private void hienHopThoaiXacNhanThoat() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(tru_allcau_kotime_cc.this);
        ...
        builder.setPositiveButton("Có", (dialog, which) -> {
            Intent intent = new Intent(tru_allcau_kotime_cc.this, tru_allcau_kotime.class);
...
// kết thúc chuyển sang màn hình finish
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(tru_allcau_kotime_cc.this, manhinh_end2.class);
